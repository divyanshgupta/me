...
export default class Introduction extends Component {
  render() {
    ...
    if(this.props.data)
    {
      ...
      var image1 = "url(images/"+this.props.data.backgroundimage1+")"
      var image2 = "url(images/"+this.props.data.backgroundimage2+")"
      var image3 = "url(images/"+this.props.data.backgroundimage3+")"
    }
      ...
      <div>
        <section id="colorlib-hero" className="js-fullheight" data-section="home">
          <div className="flexslider js-fullheight">
            <ul className="slides">
              <li style={{backgroundImage: image1}}>
              ...
              <li style={{backgroundImage: image2}}>
                <div className="overlay" />
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
                      <div className="slider-text-inner">
                        <div className="desc">
                          ...
                          <p><a className="btn btn-primary btn-learn" href="https://github.com/divyanshgupta" target="_blank" rel="noopener noreferrer">View Projects <i className="icon-briefcase3" /></a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <li style={{backgroundImage: image3}}>
                <div className="overlay" />
                <div className="container-fluid">
                  <div className="row">
                    <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text">
